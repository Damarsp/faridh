			...
			<input type="hidden" value="<?php echo $record['id_user']?>" name="id">
				<table class="table table-striped">
					<tr><td width="130">Nama Lengkap</td>
						<td><div class="col-sm-4""><input type="text" name="nama" placeholder="Nama lengkap" class="form-control" value="<?php echo $record['nama_lengkap']?>" required autocomplete="off"></div>
						</td></tr>
						<tr><td width="130">Username</td>
						<td><div class="col-sm-4""><input type="text" name="username" placeholder="Username" class="form-control" value="<?php echo $record['username']?>" required autocomplete="off"></div>
						</td></tr>
						<tr><td width="130">Password</td>
						<td><div class="col-sm-4""><input type="password" name="password" placeholder="Password" class="form-control" value="" required autocomplete="off"></div>
						</td></tr>
